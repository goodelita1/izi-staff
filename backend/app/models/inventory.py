...
from sqlalchemy import Date, DateTime, Float, Index, Integer, Text, func
...
class Inventory(Base):
    ...
    __table_args__ = (
        Index("ix_inventory_inventory_number", "inventory_number"),
        Index("ix_inventory_invoice_number", "invoice_number"),
        Index("ix_inventory_serial_number", "serial_number"),
        Index("ix_inventory_status", "status"),
        Index("ix_inventory_department", "department"),
